...
def main():
    ...
    writeValidAccounts(masterAccounts, os.path.join(sys.path[0], "validAccounts.txt"))
    writeMasterAccounts(masterAccounts, os.path.join(sys.path[0], "masterAccounts.txt"))
